...
const SocialIcon = styled.div`
    ...
    border-radius: 50%;
    color : white;
    background-color: #${props => props.color}; /* here I used props to match exact color to each icon, each icon has specific color which comes in his props as argument. */ 
    display: flex;
    align-items: center;
